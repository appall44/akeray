...
export default function NewInvoicePage() {
		...
		setTimeout(() => {
			...
			toast({
				...
				description: `Invoice has been generated${
					formData.sendImmediately ? " and sent to tenant" : ""
				}.`,
			});
	...
	const vatAmount = formData.vatIncluded
		? Math.round(parseFloat(formData.amount || "0") * 0.15)
		: 0;
				...
				<div className="animate-in fade-in duration-1000">
					...
					<div>
						...
						<p className="text-sm text-gray-500">
							Create professional invoices with your business details
						</p>
					</div>
				</div>
				...
				<form onSubmit={handleSubmit}>
							...
							>
								<Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
									<CardHeader>
										...
										<CardDescription>
											Basic invoice information and recipient
										</CardDescription>
									</CardHeader>
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<div className="space-y-2">
												...
												>
													...
													<SelectContent>
														<SelectItem value="rental">Monthly Rent</SelectItem>
									...
									<CardContent className="space-y-4">
										...
										<div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
											...
											<div className="text-yellow-700 text-sm space-y-1">
												<p>
													• Invoice will be generated with your business details
												</p>
												<p>• Tenant will receive SMS/email notification</p>
												<p>• Invoice accessible in tenant's dashboard</p>
												<p>• Payment tracking automatically enabled</p>
											</div>
										</div>
									</CardContent>
								</Card>
					...
					>
						<div className="flex justify-end space-x-4 mt-8">
							...
							>
								<Link href="/dashboard/owner/invoices">Cancel</Link>
							</Button>
							<Button
								type="submit"
